	...
	//jQuery.get(url_twitter, function(d) {
		...
		if (d.code === 200 && d.data.length > 0) {
	        ...
	        jQuery.each(d.data, function(i, result) {
	        	...
	        	jQuery('.row.tweets-container').append('<div class="col-xs-10 col-xs-offset-1 col-sm-offset-0 col-sm-4"> <section class="row tweet"> <div class="image-container nopadding col-xs-3"> <img src="' + imagen + '" alt=""> </div> <div class="data-container col-xs-9"> <div class="user-info"> <span class="user-name">' + nombre + '</span> <span class="account">' + usuario + '</span> </div> <p class="tweet-content mt-xxs mb-xxs"> ' + texto + ' </p> <div class="row statistics"> <div class="col-xs-2 col-sm-2 nopadding likes"> <a href="https://twitter.com/intent/like?tweet_id=' + id + '&&original_referer=https://dev.twitter.com"><span class="bbva-icon-favorite"></span></a> <span>' + likes + '</span> </div> <div class="col-xs-1 col-sm-2 nopadding share"> <a href="https://twitter.com/intent/retweet?tweet_id=' + id + '&&original_referer=https://dev.twitter.com"><span class="bbva-icon-share"></span></a> </div> <div class="col-xs-9 col-sm-8 nopadding date"> <span>' + fecha + '</span> </div> </div> </div> </section> </div>');
