jQuery(document).ready(function($) {
    ...
    jQuery("#add-elemento-programa").click(function(e) {        
        ...
        $('select.moderadores').first().find('option').each(function() {
            valor = jQuery(this).val();
            name = jQuery(this).html();
            jQuery("select.moderadores").last().append('<option value="' + valor + '">' + name + '</option>');
        });        
    });
