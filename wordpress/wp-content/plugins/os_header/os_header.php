...
class OS_Header_Widget extends WP_Widget {
  ...
  function form( $instance ) {
    ...
    ?>
    <p>
      <label for="<?php echo $this->get_field_id('image'); ?>"><?php _e('Imagen', 'os_header_widget'); ?>:</label>
    ...
    <p>
      ...
      <textarea class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id('box_text'); ?>" name="<?php echo $this->get_field_name('box_text'); ?>"></textarea>
    </p>
    <p>
    ...
    <p>
      <input type="checkbox" id="<?php echo $this->get_field_id('link_target'); ?>" name="<?php echo $this->get_field_name('link_target'); ?>" value="<?php echo esc_attr($instance['link_target']); ?>" class="widefat" />
