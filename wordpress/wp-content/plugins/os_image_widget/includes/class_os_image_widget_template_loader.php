 ...
 * @author  Gary Jones
 */
class OS_Image_Widget_Template_Loader {
	/**
	 ...
	 * @type string
	 */
	protected $filter_prefix = 'OS_Image_Widget';
	 ...
	 * @type string
	 */
	protected $theme_template_directory = 'os_image_widget';
	 ...
	 * @since 4.0.0
	 *
	 * @uses OS_Image_Widget_Template_Loader::get_template_possble_parts()
	 *     Create file names of templates.
	 * @uses OS_Image_Widget_Template_Loader::locate_template() Retrieve the
	 ...
	 * @since 4.0.0
	 *
	 * @uses OS_Image_Widget_Template_Loader::get_template_paths() Return a
