...
class OS_Perfiles_de_Usuario {
    ...
    public function render_metabox($post) {
        ...
        $area_expertise_3_es = get_post_meta($post_id, 'area_expertise_3', true);
        ...
        $frase_cabecera_es = get_post_meta($post_id, 'frase_cabecera', true);
        ...
        <div id="informacion_personal" name="informacion_personal">
            ...
            <table class="form-table">
                ...
                <tr class="es">
                    ...
                    <td>
                        <input type="text" name="cargo" id="cargo" value="<?php echo esc_attr($cargo_es); ?>" class="regular-text" /><br />
            ...
            <table class="form-table">
                <tr class="es">
                    <th>
                     ...
                     <td>
                        <textarea cols="40" rows="5" name="descripcion" id="descripcion"><?php echo $descripcion_es; ?></textarea>
                    </td>
                </tr>
                <tr class="en" style="display:none;">
                    <th>
            ...
            <table class="form-table">
                <tr class="es">
                    <th>
                     ...
                     <td>
                        <input type="text" name="area_expertise_1" id="area_expertise_1" value="<?php echo esc_attr($area_expertise_1_es); ?>" class="regular-text" /><br />
                    </td>
                </tr>
                ...
                <tr class="es">
                    <th>
                     ...
                     <td>
                        <input type="text" name="area_expertise_2" id="area_expertise_2" value="<?php echo esc_attr($area_expertise_2_es); ?>" class="regular-text" /><br />
                    </td>
                </tr>
                ...
                <tr class="es">
                    <th>
                     ...
                     <td>
                        <input type="text" name="area_expertise_3" id="area_expertise_3" value="<?php echo esc_attr($area_expertise_3_es); ?>" class="regular-text" /><br />
                    </td>
                </tr>
            ...
            <table class="form-table">
                ...
                <tr class="es">
                    <th>
                     ...
                     <td>
                        <textarea cols="40" rows="5" name="frase_cabecera" id="frase_cabecera"><?php echo esc_attr($frase_cabecera_es); ?></textarea><br />
